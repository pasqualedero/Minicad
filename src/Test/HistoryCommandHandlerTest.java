...
//        historyCommandHandler.handle(new CreateCmd(new TypeConstrCircle(new PosFloat(80)),new Pos(new PosFloat(100),new PosFloat(100)),graphicObjectPanel));
//        historyCommandHandler.handle(new CreateCmd(new TypeConstrRectange(new PosFloat(80),new PosFloat(90)),new Pos(new PosFloat(100),new PosFloat(100)),graphicObjectPanel));
