...
public final class RectangleObject extends AbstractGraphicObject {
	...
	public Memento getMemento() {
		return new RectangleObject.RectangleMemento(getPosition(),getDimension());
	}

	@Override
	public void setMemento(Memento m) {
		if (m instanceof RectangleObject.RectangleMemento rm){
	...
	public String toString() {
		return "RECTANGLE height: "+dim.getHeight()+", width: " + dim.getWidth() +", position: ("+position.getX()+", "+position.getY()+")";	}
